const dtransformer = require('./index');
...
describe('docs2table',() => {
    ...
    describe('unsupported use', () => {
        test('properties\'s names are not same', () => {
            ...
            expect(() => {dtransformer.docs2table(docs)}).toThrowError('docs aren\'t under same schema');
        });
...
describe('table2docs',() => {
    ...
    describe('unsupported use', () => {
        test('rows aren\'t under same schema', () => {
            ...
            expect(() => {dtransformer.table2docs(table)}).toThrowError('rows aren\'t under same schema');
        });
    })
